...
const translations = {
  es: {
    ...
    "about.p1":
      "Estudiante de 7 semestres de ingeniería de sistemas, con habilidad en la resolución de problemas y automatización de procesos, diseño y desarrollo web, diseño UX/ UI.",
    "about.p2":
    ...
    "projects.1.title": "Página web Air yyyyGo",
